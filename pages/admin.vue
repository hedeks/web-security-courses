...
<template>
    <div class="w-full flex flex-col">
        ...
        <div class="flex w-full gap-2">
            <textarea v-model="articles[0] as string" @change="changeAst"
