---
title: "Лекция 4. бимбим"
---

# Лекция 4

Пользователи современных веб сайтов ожидают более интерактивного и захватывающего опыта при использования веб сайтов, веб приложений. Поэтому веб анимация и интерактивность играют важную роль в создании привлекательных и эффективных веб сайтов.
Существуют следующие веб инструменты для достижения этой цели.
...
```html
<div id="element" style="position: relative; left: 0;">Анимируемый элемент</div>
...
<script>
  ...
  const interval = 10; // интервал обновления позиции (ms)
  const frames = duration / interval;
  const distancePerFrame = (targetPosition - position) / frames;
...
Уязвимость - это слабое место в приложении, с помощью которого потенциальный злоумышленник, может выполнять нелегитимные действия или получить несанкционированных доступ к информации.
